...
export const AcademicCareerCard = ({logo, academicName, degree, alternance, dateStart, dateEnd, redirectUrl}: AcademicCareerCardProps) => {
    return (
            ...
            <div className="flex items-center justify-between">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Link href={redirectUrl} target="_blank" className="ml-2 text-zinc-600 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white">
